 <?php  
	...
	if(isset($_POST['editartist'])){
		...
		try{
			...
			if($photo != null){
				$sql = "UPDATE artisttable SET artistName = :artistName, artistBirth = :artistBirth, artistDeath = :artistDeath, artistCentury = :artistCentury, artistNationality = :artistNationality, imageArtist = :imageArtist WHERE idArtist = '$id'";
				...
				if($step->execute()){
				   $_SESSION['message'] = 'Artist details updated as requested successfully';
				}
				else{
